...
struct FoodDeliveryApp: App {
    // MARK: State Objects
    @StateObject private var router = AppRouter()   // Handles navigation between screens
    @StateObject private var cartVM = CartViewModel() // Manages cart state and items
...
struct RootView: View {
    @EnvironmentObject var router: AppRouter   // Router injected from App
